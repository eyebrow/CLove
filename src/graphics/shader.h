...
void graphics_Shader_activate(mat4x4 const* projection, const mat4x4 *view, mat4x4 const* transform, graphics_Quad const* textureRect, float const* useColor, float ws, float hs);
